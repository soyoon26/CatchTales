...
## 🎮 게임 설명
### 입장하기
<img src="readme_assets/입장.png" width="600" />

```게임 닉네임을 입력하고 입장하기를 누릅니다.```

###  방 만들러가기 
<img src="readme_assets/방만들러가기.gif" width="600" />

```돌아가고 있는 소용돌이로 뛰어 들면 로비로 이동하게 됩니다.```

### 로비
<img src="readme_assets/로비.png" width="600" />

``` 만들어져 있는 방에 입장하거나 새로운 방을 만들 수 있습니다.```

### Tutorail 소개

<img src="readme_assets/tutorial.jpg" width="600" />

### 인트로
![인트로](readme_assets/인트로.gif)

``` 게임을 시작하기 전 인트로를 볼 수 있습니다.```

### 캐릭터 선택
<img src="readme_assets/캐릭터선택.gif" width="600" />
...
<img src="readme_assets/게임시작.gif" width="600" />
```서로 다른 랜덤 위치에서 게임이 시작됩니다. ```

#### Tab 키
![늑대조작키](readme_assets/늑대조작키.jpg)|![빨간모자조작키](readme_assets/빨간모자조작키.jpg)
---|---|

``` Tab을 누르면 조작키를 볼 수 있습니다.```

#### 총파츠 모으기
![총파츠](readme_assets/총파츠.gif)

```빛나고 있는 곳에 가면 총파츠가 있습니다. 빨간 모자가 10개를 모으면 승리합니다.```

#### 변신
<img src="readme_assets/변신.gif" width="600" />

``` 마우스를 올렸을 때 빛나는 사물을 클릭하면 그 사물로 변신 가능해 늑대를 속일 수 있습니다.```


#### 빨간모자 얼음
![빨간모자죽음](readme_assets/빨간모자죽음.gif)

```늑대가 빨간모자를 얼리고 30초가 지나기 전에 팀원이 구해지지 않는다면 죽습니다. ```

#### 같은 팀 구하기
![친구구하기](readme_assets/친구구하기.gif)

```얼어있는 팀원에게 다가가 얼음을 깨줍니다.```
#### 빨간모자 승리

<img src="readme_assets/빨간모자승리.gif" width="600" />

``` 총파츠를 10개 다 모으면 빨간 모자가 승리합니다. 다 모으지 못한다면 늑대가 승리합니다. ```

### 엔딩

<img src="readme_assets/엔딩_.gif" width="600" />
